  ...
  <FinalForm
    ...
    render={formRenderProps => {
      ...
      const lengthRequiredMessage = intl.formatMessage({
        id: 'EditListingDetailsForm.lengthRequiredMessage',
      });
      const makeRequiredMessage = intl.formatMessage({
        id: 'EditListingDetailsForm.makeRequiredMessage',
      });
      const modelRequiredMessage = intl.formatMessage({
        id: 'EditListingDetailsForm.titleRequired',
      });
      const maxLengthMessage = intl.formatMessage(
        { id: 'EditListingDetailsForm.modelRequiredMessage' },
        {
          ...
          {showTitle ? (
            <div className={css.title}>
              <FieldTextInput
                ...
                label={intl.formatMessage({ id: 'EditListingDetailsForm.lengthLabel' })}
                placeholder={intl.formatMessage({ id: 'EditListingDetailsForm.lengthPlaceholder' })}
                maxLength={TITLE_MAX_LENGTH}
                validate={composeValidators(required(lengthRequiredMessage))}
              />
              <FieldTextInput
                id={`${formId}make`}
                name="make"
                className={css.make}
                type="text"
                label={intl.formatMessage({ id: 'EditListingDetailsForm.makeLabel' })}
                placeholder={intl.formatMessage({ id: 'EditListingDetailsForm.makePlaceholder' })}
                maxLength={TITLE_MAX_LENGTH}
